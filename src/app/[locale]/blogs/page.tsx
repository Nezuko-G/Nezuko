...
import { ArrowRight, Clock, Tag, Search, ChevronRight, Rss } from "lucide-react";
...
const CATEGORIES = ["all", "ai-hr", "recruitment", "performance", "case-study"] as const;
...
const POSTS: BlogPost[] = [
    {
        slug: "ai-hiring-bias",
        category: "ai-hr",
        coverImg: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=800&q=80",
        readingTime: 6,
        featured: true,
    },
    {
        ...
        coverImg: "https://images.unsplash.com/photo-1521737852567-6949f3f9f2b5?w=800&q=80",
        readingTime: 5,
    },
    {
        slug: "performance-360",
        category: "performance",
        coverImg: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&q=80",
        readingTime: 7,
    },
    {
        slug: "sabic-case-study",
        category: "case-study",
        coverImg: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800&q=80",
        readingTime: 8,
    },
    {
        slug: "onboarding-automation",
        category: "ai-hr",
        coverImg: "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=800&q=80",
        readingTime: 5,
    },
    {
        slug: "talent-analytics",
        category: "performance",
        coverImg: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80",
        readingTime: 9,
    },
    {
        slug: "telecom-case-study",
        category: "case-study",
        coverImg: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&q=80",
        readingTime: 6,
    },
    {
        slug: "job-description-ai",
        category: "recruitment",
        coverImg: "https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=800&q=80",
        readingTime: 4,
    },
];
...
export default function BlogsPage() {
    ...
    const posts = t.raw("posts") as Record<
        string,
        { title: string; excerpt: string; author: string; authorRole: string; date: string }
    >;
                                        ...
                                        <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12">
                                            ...
                                            <div className="flex items-center gap-4">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div>
                                                        <p className="text-white text-xs font-bold">{featuredData.author}</p>
                                                        <p className="text-white/40 text-xs">{featuredData.date}</p>
                                                    </div>
                                                </div>
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <AnimatePresence mode="popLayout">
                            {filtered.length === 0 ? (
                                ...
                                >
                                    <p className="text-xl font-bold mb-2">{t("noResults.title")}</p>
                                                            ...
                                                            <div className="p-6 flex flex-col flex-1">
                                                                ...
                                                                <div className="flex items-center justify-between border-t border-gray-50 pt-4">
                                                                    <div className="flex items-center gap-2">
                                                                        ...
                                                                        <span className="text-xs font-bold text-[#0f172a]">{data.author}</span>
                                                                    </div>
                ...
                <Section dark>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-white/20 text-xs mt-4">{t("newsletter.note")}</p>
                        </div>
                    </motion.div>
                </Section>
