import { z } from "zod";
import type { Timesheet, UserSummary } from "@/app/[locale]/(hr-system)/attendance/types/timesheet.dto";
import { TimesheetDTO, UserSummaryDTO } from "@/app/[locale]/(hr-system)/attendance/types/timesheet.dto";
