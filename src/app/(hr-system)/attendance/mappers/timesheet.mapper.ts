import { z } from "zod";
import type { Timesheet, UserSummary } from "@/app/(hr-system)/attendance/types/timesheet.dto";
import { TimesheetDTO, UserSummaryDTO } from "@/app/(hr-system)/attendance/types/timesheet.dto";
