...
const BADGE_STYLES = {
  ...
  success:
    "bg-status-success/10 text-status-success border-2 border-status-success/40",
};
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <ArrowUpRight
          size={14}
          className="text-content-muted opacity-0 transition-opacity group-hover:opacity-100"
        />
      </div>
      <div>
      ...
      {badge && (
        <span
          className={`w-fit rounded-full px-2.5 py-0.5 text-[10px] font-semibold ${BADGE_STYLES[badgeVariant]}`}
        >
          {badge}
        </span>
      )}
...
export default function DashboardPage() {
  ...
  const { data: initialData, isLoading, isError, refetch } = useDashboard();
  ...
  if (isError || !initialData) {
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 text-center bg-background">
      ...
      <div className="mx-auto max-w-6xl px-4 pt-4">
        ...
        >
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(0,255,185,0.18) 0%, transparent 70%)",
            }}
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(0,255,185,0.12) 0%, transparent 70%)",
            }}
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(0,204,148,0.14) 0%, transparent 70%)",
            }}
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(0,255,185,0.09) 0%, transparent 70%)",
            }}
