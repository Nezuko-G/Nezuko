...
export function TaskForm({
    ...
    const [form, setForm] = useState<CreateTaskPayload>(() => buildInitialForm(task, projectId));
    ...
    useEffect(() => {
        ...
        api.get("/project")
            .then((res) => {
                ...
                const list: Option[] = (Array.isArray(data) ? data : [])
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) =>
                                    setForm((f) => ({ ...f, assigneeId: e.target.value || undefined }))
                                }
                    ...
                    {!projectId && (
                        <div>
                            ...
                            <select
                                ...
                                className="w-full rounded-xl border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                <option value="">{loadingProjects ? t("loading") : t("form.standaloneOrProject")}</option>
                                {projects.map((proj) => (
