import { z } from "zod";
import { LeaveRequestDTO, CreateLeaveRequestDTO, ReviewLeaveRequestDTO } from "@/app/(hr-system)/leave/types/leave.dto";
import { mapLeaveRequestFromDTO, mapLeaveRequestsFromDTO } from "@/app/(hr-system)/leave/mappers/leave.mapper";
