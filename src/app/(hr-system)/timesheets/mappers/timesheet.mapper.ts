import { z } from "zod";
import type { Timesheet, UserSummary, OvertimeReport, OvertimeReportItem } from "@/app/(hr-system)/timesheets/types/timesheet.dto";
import { TimesheetDTO, UserSummaryDTO } from "@/app/(hr-system)/timesheets/types/timesheet.dto";
...
export function mapOvertimeReportItemFromDTO(dto: any): OvertimeReportItem {
  return {
    userId: dto.userId,
